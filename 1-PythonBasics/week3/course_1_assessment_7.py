...
# Write code to compute the number of months that have more than 3 inches 
# of rainfall. Store the result in the variable num_rainy_months. 
...
lstword = sentence.split()
print(sentence[1:5])
same_letter_count=0
for a in lstword:
    fword=a[0:1]
    lword=a[len(a)-1:len(a)]
    if(fword==lword):
        same_letter_count+=1
