...
# Create a list of the second elements of each tuple and assign this list 
...
#Given is the dictionary, gold, which shows the country and the number 
# of gold medals they have earned so far in the 2016 Olympics. Create a list, 
# num_medals, that contains only the number of medals for each country. 
# You must use the .items() method. Note: The .items() method provides 
# a list of tuples. Do not use .keys() method.
