...
# and Germany had 17 medals. Create a dictionary assigned to the variable medal_count with the country names as the keys and the number of medals the country had as each key’s value.
medal_count ={'United States':70,'China':45,'Russia':30,'Germany':17,'Great Britain':38,}

#Given the dictionary swimmers, add an additional key-value pair to the dictionary 
# with "Phelps" as the key and the integer 23 as the value. 
...
# United States has won in 2016, and in which category they have won it in. 
# Using dictionary mechanics, assign the value of the key "Fencing" to a variable 
