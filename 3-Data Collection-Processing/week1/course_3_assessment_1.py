...
nested = {'data': ['finding', 23, ['exercises', 'hangout', 34, 'whole']], 'window': ['part', 'whole', [], 'sum', ['math', 'calculus', 'algebra', 'geometry', 'statistics',['physics', 'chemistry', 'biology']]]}
data=twentyfour=whole=physics=False
...
# Great Britain’s gold medal count from the London Olympics to the variable 
# london_gold. Use indexing. Do not hardcode.
nested_d = {'Beijing':{'China':51, 'USA':36, 'Russia':22, 'Great Britain':19}, 'London':{'USA':46, 'China':38, 'Great Britain':29, 'Russia':22}, 'Rio':{'USA':35, 'Great Britain':22, 'China':20, 'Germany':13}}
london_gold=nested_d['London']['Great Britain']
for aa in nested_d:
    print(nested_d[aa])

#Below, we have provided a nested dictionary. Index into the dictionary to 
# create variables that we have listed in the ActiveCode window.
...
for olym in nested_d.keys():
    US_count.append(nested_d[olym]['USA'])
...
#Given below is a list of lists of athletes. Create a list, t, that saves 
# only the athlete’s name if it contains the letter “t”. If it does not contain 
