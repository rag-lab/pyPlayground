...
map_testing = list(map((lambda r:'Fruit: '+r), lst_check))

#Below, we have provided a list of strings called countries. Use filter to produce 
# a list called b_countries that only contains the strings from countries 
# that begin with B.
countries = ['Canada', 'Mexico', 'Brazil', 'Chile', 'Denmark', 'Botswana', 'Spain', 'Britain', 'Portugal', 'Russia', 'Thailand', 'Bangladesh', 'Nigeria', 'Argentina', 'Belarus', 'Laos', 'Australia', 'Panama', 'Egypt', 'Morocco', 'Switzerland', 'Belgium']
b_countries  = list(filter(lambda c: "B" in c,countries))

#Below, we have provided a list of tuples that contain the names of Game of Thrones
#  characters. Using list comprehension, create a list of strings called 
...
# that contains the names of students who passed the class (had a final grade 
# of 70 or greater).
...
l2 = ['right', 'down', 'back']
l3 = zip(l1,l2)
opposites = list(filter(lambda r: len(r[0])>3 and len(r[1])>3, l3))
...
endangered = [r1 for (r1,r2) in pop_info if (r2<2500)]
